            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <NavLink
                  ...
                  className={`group relative flex items-center gap-2.5 rounded-[13px] py-2 px-4 font-medium text-white hover:text-[#7A231C] duration-300 ease-in-out hover:bg-gray-100 dark:hover:bg-meta-4 ${pathname.includes('withdrawal-history') && 'bg-white dark:bg-meta-4 text-[#7A231C]'
                    }`}
                >
                  <svg 
                   className="[&>path]:stroke-white group-hover:[&>path]:stroke-[#7A231C] group-[.bg-white]:[&>path]:stroke-[#7A231C]"
